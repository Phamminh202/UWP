...
namespace BaiThi2.Adapter
{
    class SQLiteHelper
    {
        private readonly string dbName = "customer.db";
        ...
        private SQLiteHelper()
        {
            ...
            var sql_txt = @"create table if not exists Customer(Id integer identity(1,1) primary key,Name varchar(255),Password varchar(255))";
